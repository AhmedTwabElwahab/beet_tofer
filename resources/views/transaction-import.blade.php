...
<div class="max-w-md mx-auto bg-white rounded-lg shadow-md p-6">
    <h2 class="text-2xl font-bold mb-6 text-center">Import Transactions from Excel</h2>
    
    <form action="{{ route('transaction.import') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        @csrf
        ...
        <div class="bg-blue-50 p-4 rounded-md">
            ...
            <ul class="text-sm text-blue-700 space-y-1">
                <li>• Column 1: device_number</li>
                <li>• Column 2: amount</li>
                <li>• Column 3: date</li>
            </ul>
        </div>
